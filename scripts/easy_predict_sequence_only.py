...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-fasta-path", type=str, default="data/uniprot_trembl.fasta")
...
def main():
    ...
    os.system("python -m terpeneminer.src.screening.tps_predict_fasta --model esm-1v-finetuned-subseq"
    ...
    os.system(f"python -m terpeneminer.src.screening.gather_detections_to_csv --screening-results-root {intermediate_outputs_root}/detections_plm --output-path {args.output_csv_path} --delete-individual-files")
